...
/***/ function(module, exports, __webpack_require__) {
	...
	window.Muninn = function ErrorLogger(recipientEmailAddress) {
	  var slackOption = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
	
	  // actual email function
	  var url = 'https://emailservice-memsearch.rhcloud.com/email';
	  ...
	  function sendItAway(errorText) {
	    ...
	    function requestWrapper(callback) {
	      return _superagent2.default.post(url).send(data).end(callback);
	    }
	  ...
	  window.onerror = function (errorMsg, url, lineNo, columnNo, errorObj) {
	    var message = 'Here\'s the error message:\n';
